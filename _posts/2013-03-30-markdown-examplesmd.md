...
layout: post
title: "Markdown语法示例"
date: 2013-03-30 22:16
category: "技术"
tags: [学习]
---
{% include JB/setup %}

要想方便的进行博客写作，那么Markdown是必不可少的工具。本文将通过一些简单的例子来说明Markdown的用法。
...
*注：ref中不区分大小写。*   
	...
	这是一个Inline[示例](http://www.aogun.com "可选的title")。
	这是一个Reference[示例][ref]。
	[ref]: http://www.aogun.com

#### 效果：

这是一个*Inline*[示例](http://www.aogun.com "可选的title")。   
...
#### 语法：
	...
	Inline示例：![替代文本](/assets/images/avator1.jpg "可选的title")
	Reference示例：![替代文本][pic]
	[pic]: /assets/images/avator2.jpg "可选的title"
	HTML示例：<img src="/assets/images/avator1.jpg" alt="替代文本" title="标题文本" width="200" />
